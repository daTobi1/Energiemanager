...
export default function CircuitsPage() {
  const { circuits, generators, storages, rooms, addCircuit, updateCircuit, removeCircuit } = useEnergyStore()
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-dark-hover rounded-lg border border-dark-border">
            <p className="text-xs text-dark-faded">Zuordnungen zu Speichern, Erzeugern, Räumen und Zählern werden im <a href="/energy-flow" className="text-emerald-400 hover:underline">Energiefluss-Diagramm</a> per Drag & Drop hergestellt.</p>
          </div>
