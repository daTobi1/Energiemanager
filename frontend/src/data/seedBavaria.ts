...
export function createBavariaSeedData() {
  ...
  const hausanschluss: GridGenerator = {
    ...
    ports: [
      { id: uuid(), side: 'input', energy: 'electricity', label: 'Netzbezug' },
      { id: uuid(), side: 'output', energy: 'electricity', label: 'Einspeisung' },
    ],
    gridMaxPowerKw: 55,
    gridPhases: 3,
    gridVoltageV: 400,
  ...
  const bhkw: ChpGenerator = {
    ...
    connectedGeneratorIds: [],
    ports: [
      { id: uuid(), side: 'input', energy: 'gas', label: 'Erdgas' },
      { id: uuid(), side: 'output', energy: 'electricity', label: 'Strom' },
      { id: uuid(), side: 'output', energy: 'heat', label: 'Wärme' },
    ],
  ...
  const kaeltemaschine: ChillerGenerator = {
    ...
    connectedGeneratorIds: [],
    ports: [
      { id: uuid(), side: 'input', energy: 'electricity', label: 'Strom' },
      { id: uuid(), side: 'output', energy: 'cold', label: 'Kälte' },
    ],
    coolingPowerKw: 15,
  ...
  const batterie: BatteryStorage = {
    ...
    connectedGeneratorIds: ['grid', ids.pvSued, ids.bhkw],
  ...
  const consumers: Consumer[] = [
    ...
    },
    {
      ...
      connectedSourceIds: ['grid', ids.batterie],
